...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['booking_id'])) {
    ...
    // Get user email and fullname from users table by matching fullname
    $stmt = $conn->prepare("SELECT email, fullname FROM users WHERE fullname = ?");
    ...
    // Log insertion removed due to missing logs table
